// @ts-ignore - Export conflicts// @ts-ignore - Export conflicts// @ts-ignore - Export conflicts// CORS configuration for all allowed origins - Firebase v2 compatible with explicit types
